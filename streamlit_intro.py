...
input_text = st.text_input('Type something','Type')
...
st.markdown('this is ___really imp___')
st.markdown('## This is subheading')
...
if button:
    st.text('This is info')
    st.info('I am clicked')
    st.toast('I am disappered')
...
# select nymberical value from the given list
# TH = 0.5,

st.slider('Set thershold',0,100,step = 10)
